...
def test1(request):
    ...
    res_dict = {}
    if data == '1':
        with open('./static/cvc_code.json') as jf:
            jsondata = json.load(jf)
            keys = jsondata.keys()
            with open ('./static/cvc_text.csv', 'r') as cf:
        ...
        with open('./static/highway_code.json') as jf:
            jsondata = json.load(jf)
            keys = jsondata.keys()
            with open ('./static/highway_text.csv', 'r') as cf:
                reader = csv.reader(cf)
                for row in reader:
                    if row[0] in keys:
                        res_dict[row[0]] = row[1]
        ...
        with open('./static/cvm_code.json') as jf:
            jsondata = json.load(jf)
            keys = jsondata.keys()
            with open ('./static/cvm_text.csv', 'r') as cf:
                reader = csv.reader(cf)
                for row in reader:
                    if row[0] in keys:
                        res_dict[row[0]] = row[1]
        ...
        with open('./static/cva_code.json') as jf:
            jsondata = json.load(jf)
            keys = jsondata.keys()
            with open ('./static/cva_text.csv', 'r') as cf:
                reader = csv.reader(cf)
                for row in reader:
                    if row[0] in keys:
                        res_dict[row[0]] = row[1]
        ...
        with open('./static/cvb_code.json') as jf:
            jsondata = json.load(jf)
            keys = jsondata.keys()
            with open ('./static/cvb_text.csv', 'r') as cf:
                reader = csv.reader(cf)
                for row in reader:
                    if row[0] in keys:
                        res_dict[row[0]] = row[1]
